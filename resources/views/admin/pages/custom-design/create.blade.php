            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Create Custom Design</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Custom Designs</a></li>
                                    <li class="breadcrumb-item active">Create Custom Design</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" action="{{ route('custom_designs.store') }}"
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                            <div id="catalogs-container">
                                                <!-- Catalogs will be dynamically added here -->
                                            </div>
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                <input type="text" class="form-control" id="catalog_name_${catalogCount}" name="catalog_names[]" required>
            `;

                    catalogFrontCol.innerHTML = `
                <label for="catalog_front_${catalogCount}" class="form-label mt-3">Frontside Image</label>
                <input type="file" class="form-control dropify${catalogCount}" id="catalog_front_${catalogCount}" name="catalog_fronts[]" required data-allowed-file-extensions="jpg jpeg png gif">
            `;

                    catalogBackCol.innerHTML = `
                <label for="catalog_back_${catalogCount}" class="form-label mt-3">Backside Image</label>
                <input type="file" class="form-control dropify${catalogCount}" id="catalog_back_${catalogCount}" name="catalog_backs[]" required data-allowed-file-extensions="jpg jpeg png gif">
            `;
