        ...
        <div class="col-xl-12">
          <div class="card">
            <div class="card-body">
              ...
              <a class="btn btn-soft-primary waves-effect waves-light mb-2" href="{{ route('photos.create') }}">
                + Create New Photo </a>
              ...
              <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      @if ($photo->image)
                      <img src="{{ asset('uploads/photos/' . $photo->image) }}" alt="{{ $photo->title }}" width="80">
                      @else
                      No Image
                      @endif
                    </td>
                    ...
                    <td>
                      ...
                      <form hidden action="{{ route('photos.destroy', $photo->id) }}" id="form{{ $photo->id }}"
                        method="get">
                        @csrf
                      </form>
                    ...
                    {{-- <td>
                                            <a href="{{ route('photos.edit', $photo->id) }}" class="btn btn-sm
                    btn-warning">Edit</a>
