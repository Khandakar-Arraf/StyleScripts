        ...
        <div class="col-xl-12">
          <div class="card">
            <div class="card-body">
              ...
              <a class="btn btn-soft-primary waves-effect waves-light mb-2" href="{{ route('hero.create') }}">
                + Create New Hero </a>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a class="btn btn-success waves-effect btn-circle waves-light"
                        ...
                        <i class="fa fa-check"></i> </a> @endif

                      <a class="btn btn-primary waves-effect btn-circle waves-light"
                        href="{{ route('hero.edit',$item->id) }}">
                        <i class="fa fa-edit"></i> </a>
                      <form hidden action="{{ route('hero.destroy',$item->id) }}" id="form{{ $item->id }}" method="get">
                        {{-- @method('Delete') --}}
                        @csrf
                      </form>
                    ...
                    {{-- <td>
                                            <a href="{{ route('hero.edit', $hero->id) }}" class="btn btn-sm
                    btn-warning">Edit</a>
