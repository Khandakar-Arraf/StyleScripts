        ...
        <div class="col-xl-12">
          <div class="card">
            <div class="card-body">
              ...
              <a class="btn btn-soft-primary waves-effect waves-light mb-2" href="{{ route('services.create') }}">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <form hidden action="{{ route('services.destroy', $service->id) }}" id="form{{ $service->id }}"
                        method="get">
                        @csrf
                      </form>
