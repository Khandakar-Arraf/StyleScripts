                ...
                <div class="col-lg-4">
                    ...
                    <div class="footer-widget">
                        <a href="#" class="footer-widget__logo"><img
                              src="{{ asset('') }}uploads/content/{{ $content->website_logo }}" alt="Logo" width="150"
                              height="32"></a>

                        <div class="footer-widget__info">
                            <span class="title">Call us</span>
                            <span class="number">{{ $content->website_phone}}</span>
                        </div>
                        <div class="footer-widget__info">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="footer-widget">
                                ...
                                <ul class="footer-widget__link">
                                    ...
                                    <li><a href="become-an-instructor.html">Become A Instructor</a></li>
                                </ul>
                            </div>
                            <!-- Footer Widget End -->
                        </div>
